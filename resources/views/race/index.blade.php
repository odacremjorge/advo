...
@endif
<center><h4>Registro de Nuevo Dato a la Carrera del Jugador: {{$player->name_player}} </h4></center>
                                            ...
                                            <table id="myTable" class="display nowrap cell-border" style="width:100%">
                                              ...
                                              @foreach($rec as $data) 
                                                <tr>
                                                    ...
                                                    <form
                                                            action="{{ route('race.destroy', $data->id) }}"
                                                            method="POST">
                                                            <a href="/race/{{$data->id}}/edit" class="btn" title="Editar"><i class="fa fa-edit" ></i></a>
                                                   
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn1"
                                                                    onclick="return confirm('¿Seguro que quiere eliminar el registro de la trayectoria del jugador?')"
