...
<div class="container">
<main>
        <center><h1>ACTUALIZAR CLUB</h1><br></center>
...
<form action="{{ route('team.update', $team->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <label>Nombre del Club:</label>
                    <br><br>
                        <input class="controls" type="text" value= "{{$team->name_team}}" name="Name" id="Name" placeholder="Ingrese el Nombre del Club *">
                        <br>    
                </div>
                <div class="col-xl-3">
                <label>Personeria Juridica:</label>
                    <br><br>
                        <input class="controls" type="text" value= "{{$team->personality}}" name="Personeria" id="Personeria" placeholder="Ingrese la Personeria Juridica">
                        <br>    
                </div>
                <div class="col-xl-3">
                <label>Fecha de Creación:</label>
                    <br><br>
                        <input class="controls" type="date" value= "{{$team->date_creation}}" name="Date" id="Date" placeholder="Ingrese Fecha de Creación">
                        <br>    
                </div>
                <div class="col-xl-6">
                ...
                <label>Delegado:</label>
                    <br><br>
                        <input class="controls" type="text" value= "{{$team->manager}}" name="Manager" id="Manager" placeholder="Ingrese Nombre del Delegado ">                 
                        <br>    
                </div>
                <div class="col-xl-3"> 
                ...
                <label>Telefono de Contacto:</label>
                    <br><br>
                        <input class="controls" type="text" value= "{{$team->phone_manager}}" name="Phone" id="Phone" placeholder="Ingrese el Telefono">                 
                        <br>    
                </div>
                <div class="col-xl-6"> 
