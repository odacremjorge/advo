...
<center><h4>Actualizar Historial</h4></center>
        <form action="{{ route('record.update', $recor->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
                ...
                <label>Año:</label>
                <br><br>
                        <input class="controls" type="number" value="{{$recor->year}}"name="Year" id="Year" placeholder="Ingrese el año del campeonato">
                        <br>    
                </div>
            ...
            <br><br>
                    <input class="controls" type="text" value="{{$recor->team_dep}}"name="Team" id="Team" placeholder="Ingrese el club o ciudad">
                    <br>    
            </div>
