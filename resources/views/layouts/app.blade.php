...
<head>
    ...
    <style>
        body {
    background:linear-gradient(rgba(148, 168, 199, 0.0), rgba(148, 168, 199, 0.0)), url("../images/fondo4.jpg");
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-transparent shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}" >
                    <img src="{{asset('images/balon5.gif')}}" width="130" loading="lazy">
    ...
    <footer class="container">
       ...
       <center> <p>&copy; 2022 JAMA MSMM N&J</p></center>
      </footer>
