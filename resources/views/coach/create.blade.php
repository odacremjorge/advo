...
<div class="container">
<main>
        <center><h1>CREAR ENTRENADOR</h1><br></center>
...
<form action="{{ route('coach.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="col-xl-3">
                        <input class="controls" type="text" name="CI" id="CI" placeholder="Ingrese el carnet de Identidad">
                        <br>    
                </div>
                <div class="col-xl-3">
                ...
                <div class="col-xl-3">
                        <input class="controls" type="number" name="Age" id="Age" placeholder="Ingrese la Edad ">                 <br>    
                </div>
                <div class="col-xl-3"> 
